...
namespace Renderer {
	...
	public:
		...
		static void printTextWrapping( Text text, const int& size, const bool& centr = LEFT, const double& Time = 0);
		static void printText(const Text& text, const double& Time=0);
